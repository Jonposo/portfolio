      ...
      <div className="div">
        <div className="overlap-group">
          ...
          <div className="flexcontainer">
            <p className="text">
              <span className="span">
                <a href="https://discord.com/" className="span" target="_blank"><img src="https://github.com/Jonposo/portfolio/blob/master/docs/assets/discord.png?raw=true" width="25" height="25" className="icon"></img> maxi2007</a>
                <br />
              </span>
            </p>
            ...
            <p className="text">
              <span className="span">
                <a href="https://www.instagram.com/maximiliankomposto/" className="span" target="_blank"><img src="https://github.com/Jonposo/portfolio/blob/master/docs/assets/instagram.png?raw=true" width="25" height="25" className="icon"></img>maximiliankomposto</a>
                <br />
              </span>
            </p>
            ...
            <p className="text">
              <span className="span">
                <a href="https://github.com/Jonposo" className="span" target="_blank"><img src="https://github.com/Jonposo/portfolio/blob/master/docs/assets/github.png?raw=true" width="25" height="25" className="icon"></img>Jonposo</a>
                <br />
              </span>
            </p>
            ...
            <p className="text">
              <span className="span">
                <a href="https://www.linkedin.com/in/maximilian-fabriani-pieksma-40498932a/" className="span" target="_blank"><img src="https://github.com/Jonposo/portfolio/blob/master/docs/assets/linkedin.png?raw=true" width="25" height="25" className="icon"></img>Maximilian Fabriani Pieksma</a>
                </span>
            </p>
          </div>
        </div>
        ...
        <div className="div-wrapper">
          ...
          <a href="./docs/assets/CV Maximilian Fabriani Pieksma.pdf">View full résumé:</a>
          </div>
        </div>
